...
if("TRUE" STREQUAL "TRUE")
  set(ik_SOURCE_PREFIX /home/cc/ee106a/fl21/class/ee106a-aer/ros_workspaces/lab5/src/ik)
  set(ik_DEVEL_PREFIX /home/cc/ee106a/fl21/class/ee106a-aer/ros_workspaces/lab5/devel)
  set(ik_INSTALL_PREFIX "")
  set(ik_PREFIX ${ik_DEVEL_PREFIX})
else()
  set(ik_SOURCE_PREFIX "")
  set(ik_DEVEL_PREFIX "")
  set(ik_INSTALL_PREFIX /home/cc/ee106a/fl21/class/ee106a-aer/ros_workspaces/lab5/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ik' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fl21/class/ee106a-aer/ros_workspaces/lab5/src/ik/${idir}'.  ${_report}")
    endif()
